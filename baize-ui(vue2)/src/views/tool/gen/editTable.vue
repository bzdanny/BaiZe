    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="字段信息" name="cloum">
        <el-table ref="dragTable" :data="cloumns" row-key="columnId" :max-height="tableHeight">
          ...
          />
          <el-table-column label="字段描述" min-width="9%">
          ...
          <el-table-column
            ...
            :show-overflow-tooltip="true"
          />
          <el-table-column label="Go类型" min-width="8%">
            <template slot-scope="scope">
          ...
          <el-table-column label="Go属性" min-width="9%">
            <template slot-scope="scope">
              <el-input v-model="scope.row.goField"></el-input>
            </template>
          </el-table-column>

          <el-table-column label="HTML属性" min-width="9%">
            <template slot-scope="scope">
          ...
          <el-table-column label="显示类型" min-width="8%">
            <template slot-scope="scope">
          ...
          <el-table-column label="字典类型" min-width="8%">
            <template slot-scope="scope">
